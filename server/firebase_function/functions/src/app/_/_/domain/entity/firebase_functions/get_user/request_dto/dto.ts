...
export class GetUserFirebaseFunctionsRequestDTO {
    I000 = 0;
    // I001 = 0;
    // I002 = 0;
    // I003 = 0;
    ...
    static fromString(jsonString: any): GetUserFirebaseFunctionsRequestDTO {
        const data = (typeof jsonString === "string") ? JSON.parse(jsonString) : jsonString;

        const obj = new GetUserFirebaseFunctionsRequestDTO();
