...
export class GetUserFirebaseFunctionsResponseDTO {
    I000 = 0;
    // I001 = 0;
    // I002 = 0;
    // I003 = 0;
    ...
    C000: UserModel = new UserModel();
    // C001: UserModel = user UserModel();
    // C002: UserModel = user UserModel();
    // C003: UserModel = user UserModel();
    // C004: UserModel = user UserModel();
    // C005: UserModel = user UserModel();
    // C006: UserModel = user UserModel();
    // C007: UserModel = user UserModel();
    // C008: UserModel = user UserModel();
    // C009: UserModel = user UserModel();
    // C010: UserModel = user UserModel();
    // C011: UserModel = user UserModel();
    // C012: UserModel = user UserModel();
    // C013: UserModel = user UserModel();
    // C014: UserModel = user UserModel();
    // C015: UserModel = user UserModel();
    // C016: UserModel = user UserModel();
    // C017: UserModel = user UserModel();
    // C018: UserModel = user UserModel();
    // C019: UserModel = user UserModel();
    // C020: UserModel = user UserModel();
    ...
    static fromString(jsonString: any): GetUserFirebaseFunctionsResponseDTO {
        const data = (typeof jsonString === "string") ? JSON.parse(jsonString) : jsonString;

        const obj = new GetUserFirebaseFunctionsResponseDTO();
        ...
        obj.C000 = UserModel.fromString(data["C000"] ?? new UserModel().toString());
        // obj.C001 = UserModel.fromString(data["C001"] ?? user UserModel().toString());
        // obj.C002 = UserModel.fromString(data["C002"] ?? user UserModel().toString());
        // obj.C003 = UserModel.fromString(data["C003"] ?? user UserModel().toString());
        // obj.C004 = UserModel.fromString(data["C004"] ?? user UserModel().toString());
        // obj.C005 = UserModel.fromString(data["C005"] ?? user UserModel().toString());
        // obj.C006 = UserModel.fromString(data["C006"] ?? user UserModel().toString());
        // obj.C007 = UserModel.fromString(data["C007"] ?? user UserModel().toString());
        // obj.C008 = UserModel.fromString(data["C008"] ?? user UserModel().toString());
        // obj.C009 = UserModel.fromString(data["C009"] ?? user UserModel().toString());
        // obj.C010 = UserModel.fromString(data["C010"] ?? user UserModel().toString());
        // obj.C011 = UserModel.fromString(data["C011"] ?? user UserModel().toString());
        // obj.C012 = UserModel.fromString(data["C012"] ?? user UserModel().toString());
        // obj.C013 = UserModel.fromString(data["C013"] ?? user UserModel().toString());
        // obj.C014 = UserModel.fromString(data["C014"] ?? user UserModel().toString());
        // obj.C015 = UserModel.fromString(data["C015"] ?? user UserModel().toString());
        // obj.C016 = UserModel.fromString(data["C016"] ?? user UserModel().toString());
        // obj.C017 = UserModel.fromString(data["C017"] ?? user UserModel().toString());
        // obj.C018 = UserModel.fromString(data["C018"] ?? user UserModel().toString());
        // obj.C019 = UserModel.fromString(data["C019"] ?? user UserModel().toString());
        // obj.C020 = UserModel.fromString(data["C020"] ?? user UserModel().toString());

        obj.J000 = ((typeof (data["J000"] ?? "[]") === "string") ? JSON.parse(data["J000"]) : data["J000"]).map(UserModel.fromString);
        // obj.J001 = ((typeof (data["J001"] ?? "[]") === "string") ? JSON.parse(data["J001"]) : data["J001"]).map(UserModel.fromString);
        // obj.J002 = ((typeof (data["J002"] ?? "[]") === "string") ? JSON.parse(data["J002"]) : data["J002"]).map(UserModel.fromString);
        // obj.J003 = ((typeof (data["J003"] ?? "[]") === "string") ? JSON.parse(data["J003"]) : data["J003"]).map(UserModel.fromString);
        // obj.J004 = ((typeof (data["J004"] ?? "[]") === "string") ? JSON.parse(data["J004"]) : data["J004"]).map(UserModel.fromString);
        // obj.J005 = ((typeof (data["J005"] ?? "[]") === "string") ? JSON.parse(data["J005"]) : data["J005"]).map(UserModel.fromString);
        // obj.J006 = ((typeof (data["J006"] ?? "[]") === "string") ? JSON.parse(data["J006"]) : data["J006"]).map(UserModel.fromString);
        // obj.J007 = ((typeof (data["J007"] ?? "[]") === "string") ? JSON.parse(data["J007"]) : data["J007"]).map(UserModel.fromString);
        // obj.J008 = ((typeof (data["J008"] ?? "[]") === "string") ? JSON.parse(data["J008"]) : data["J008"]).map(UserModel.fromString);
        // obj.J009 = ((typeof (data["J009"] ?? "[]") === "string") ? JSON.parse(data["J009"]) : data["J009"]).map(UserModel.fromString);
        // obj.J010 = ((typeof (data["J010"] ?? "[]") === "string") ? JSON.parse(data["J010"]) : data["J010"]).map(UserModel.fromString);
        // obj.J011 = ((typeof (data["J011"] ?? "[]") === "string") ? JSON.parse(data["J011"]) : data["J011"]).map(UserModel.fromString);
        // obj.J012 = ((typeof (data["J012"] ?? "[]") === "string") ? JSON.parse(data["J012"]) : data["J012"]).map(UserModel.fromString);
        // obj.J013 = ((typeof (data["J013"] ?? "[]") === "string") ? JSON.parse(data["J013"]) : data["J013"]).map(UserModel.fromString);
        // obj.J014 = ((typeof (data["J014"] ?? "[]") === "string") ? JSON.parse(data["J014"]) : data["J014"]).map(UserModel.fromString);
        // obj.J015 = ((typeof (data["J015"] ?? "[]") === "string") ? JSON.parse(data["J015"]) : data["J015"]).map(UserModel.fromString);
        // obj.J016 = ((typeof (data["J016"] ?? "[]") === "string") ? JSON.parse(data["J016"]) : data["J016"]).map(UserModel.fromString);
        // obj.J017 = ((typeof (data["J017"] ?? "[]") === "string") ? JSON.parse(data["J017"]) : data["J017"]).map(UserModel.fromString);
        // obj.J018 = ((typeof (data["J018"] ?? "[]") === "string") ? JSON.parse(data["J018"]) : data["J018"]).map(UserModel.fromString);
        // obj.J019 = ((typeof (data["J019"] ?? "[]") === "string") ? JSON.parse(data["J019"]) : data["J019"]).map(UserModel.fromString);
        // obj.J020 = ((typeof (data["J020"] ?? "[]") === "string") ? JSON.parse(data["J020"]) : data["J020"]).map(UserModel.fromString);
