...
//     // L020: string[] = [];
//
//     C000: SomeModel = new SomeModel();
//     // C001: SomeModel = user SomeModel();
//     // C002: SomeModel = user SomeModel();
//     // C003: SomeModel = user SomeModel();
//     // C004: SomeModel = user SomeModel();
//     // C005: SomeModel = user SomeModel();
//     // C006: SomeModel = user SomeModel();
//     // C007: SomeModel = user SomeModel();
//     // C008: SomeModel = user SomeModel();
//     // C009: SomeModel = user SomeModel();
//     // C010: SomeModel = user SomeModel();
//     // C011: SomeModel = user SomeModel();
//     // C012: SomeModel = user SomeModel();
//     // C013: SomeModel = user SomeModel();
//     // C014: SomeModel = user SomeModel();
//     // C015: SomeModel = user SomeModel();
//     // C016: SomeModel = user SomeModel();
//     // C017: SomeModel = user SomeModel();
//     // C018: SomeModel = user SomeModel();
//     // C019: SomeModel = user SomeModel();
//     // C020: SomeModel = user SomeModel();
//
//     J000: SomeModel[] = [];
//     // J001: SomeModel[] = [];
//     // J002: SomeModel[] = [];
...
//
//                 E000: SomeEnumToString(this.E000),
//                 // E001: SomeEnumToString(this.E001),
//                 // E002: SomeEnumToString(this.E002),
//                 // E003: SomeEnumToString(this.E003),
//                 // E004: SomeEnumToString(this.E004),
//                 // E005: SomeEnumToString(this.E005),
//                 // E006: SomeEnumToString(this.E006),
//                 // E007: SomeEnumToString(this.E007),
//                 // E008: SomeEnumToString(this.E008),
//                 // E009: SomeEnumToString(this.E009),
//                 // E010: SomeEnumToString(this.E010),
//                 // E011: SomeEnumToString(this.E011),
//                 // E012: SomeEnumToString(this.E012),
//                 // E013: SomeEnumToString(this.E013),
//                 // E014: SomeEnumToString(this.E014),
//                 // E015: SomeEnumToString(this.E015),
//                 // E016: SomeEnumToString(this.E016),
//                 // E017: SomeEnumToString(this.E017),
//                 // E018: SomeEnumToString(this.E018),
//                 // E019: SomeEnumToString(this.E019),
//                 // E020: SomeEnumToString(this.E020),
//             }
//         );
//     }
//
...
//         // obj.L020 = data["L020"] ?? [];
//
//         obj.C000 = SomeModel.fromString(data["C000"] ?? new SomeModel().toString());
